...
Partial Class Form3
    ...
    Private Sub InitializeComponent()
        ...
        ' btconsulta
        ' 
        btconsulta.Font = New Font("Yu Gothic", 11.25F, FontStyle.Bold, GraphicsUnit.Point, CByte(0))
        ...
        Label4.Font = New Font("Yu Gothic Medium", 12F, FontStyle.Bold Or FontStyle.Italic, GraphicsUnit.Point, CByte(0))
        ...
        ' btborrar
        ' 
        btborrar.Font = New Font("Yu Gothic", 11.25F, FontStyle.Bold, GraphicsUnit.Point, CByte(0))
        ...
        ' bteditar
        ' 
        bteditar.Font = New Font("Yu Gothic", 11.25F, FontStyle.Bold, GraphicsUnit.Point, CByte(0))
        ...
        Label3.Font = New Font("Yu Gothic Medium", 12F, FontStyle.Bold Or FontStyle.Italic, GraphicsUnit.Point, CByte(0))
        ...
        Label2.Font = New Font("Yu Gothic Medium", 12F, FontStyle.Bold Or FontStyle.Italic, GraphicsUnit.Point, CByte(0))
        ...
        Label1.Font = New Font("Yu Gothic Medium", 12F, FontStyle.Bold Or FontStyle.Italic, GraphicsUnit.Point, CByte(0))
        ...
        ' btagregar
        ' 
        btagregar.Font = New Font("Yu Gothic", 11.25F, FontStyle.Bold, GraphicsUnit.Point, CByte(0))
